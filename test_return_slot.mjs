...
console.log('\n── ⑦ 時間帯の割りふりは予約とまったく同じ ──');
{
  ...
  /* 🔴 v1.70.0 枠も「いちばん遅くなり得る時刻」で決まる（ゆうた確定）
     🔴 v1.105.0 AM の終わりを 11:59 にしたので **AM は11時の枠**（12時台に被せない） */
  ok('AM→11 / PM→18 / 朝一→09 / お昼→13 / 夕方→18',
     JSON.stringify(r) === JSON.stringify([['AM', '11'], ['PM', '18'], ['朝一', '09'], ['お昼', '13'], ['夕方', '18']]), r);
}
