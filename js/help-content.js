      ...
      <div class="help-step"><ol>
        ...
        <li><strong>入庫時間のショートカット（v1.33.0）</strong>＝<strong>AM／PM／朝一／お昼／夕方／決まり次第／レッカー／鍵ポスト／未定</strong>。
          ...
          <ul>
            ...
            <li><strong>並び順は決まった時間で計算</strong>します（AM＝9時／PM＝13時／朝一＝9時／お昼＝12時／夕方＝16時半）。この時間は画面には出ません。</li>
            <li><strong>決まり次第・レッカー・鍵ポスト・未定</strong>は「時間がまだ分からない」扱いで、その日の<strong>いちばん後ろ</strong>に並びます。</li>
          </ul>
        </li>
      ...
      <ul>
        ...
        <li><strong>担当車両（v1.41.0 → v1.48.0）</strong>＝右上の「担当車両」を押すと、<strong>自分が担当（フロント）のカードだけ</strong>が残り、ほかは一時的に隠れます。
          <ul>
            ...
            <li>よその課から来たカードには右上に<strong>「1課」「2課」の印</strong>が付きます（カード左の色帯も 国産＝緑／輸入＝桃 のままです）。</li>
