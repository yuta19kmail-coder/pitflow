...
(function () {
  ...
  window.HELP_CONTENTS = {
    ...
    newreserve: `
      ...
      <ul>
        <li><strong>入力チェック</strong>：抜けがないか確認だけ（保存はしない）。</li>
      ...
      <h3><i data-ic=calendar data-ics=15></i> 担当の予定（MHS連携・v1.22.0）</h3>
      <p>右パネルに、<strong>フロント担当に選んだ人の入庫日の予定</strong>が出ます。MHSに入っている予定をそのまま持ってきています。</p>
      <ul>
        <li>出るもの＝<strong>社内予定・外出/不在・ルーティン業務・当番・その日の休み</strong>。来客（入庫）とは別の予定です。</li>
